...
function makexml4object($ttltext,$objecttype){
		...
		$xml_text = "";
		if($objecttype == 'tool'){
			$style_text = "labelPosition=center;html=1;shape=mxgraph.basic.frame;dx=3;pd3layer=".$object_layer.";pd3type=tool;strokeColor=".$strokeColor.";dashed=1;fontSize=14;fillColor=none;strokeWidth=1;";
		}elseif($objecttype == 'document'){
			$style_text = "rounded=0;whiteSpace=wrap;html=1;pd3layer=".$object_layer.";pd3type=document;strokeColor=".$strokeColor.";dashed=1;fontSize=14;fillColor=none;strokeWidth=1;dashPattern=1;";
		}elseif($objecttype == 'engineer'){
			$style_text="rounded=0;whiteSpace=wrap;html=1;pd3layer=".$object_layer.";pd3type=engineer;strokeColor=".$strokeColor.";dashed=1;fontSize=14;fillColor=none;strokeWidth=1;dashPattern=1;";
		}elseif($objecttype == 'rationale'){
			$style_text="rounded=0;whiteSpace=wrap;html=1;pd3layer=".$object_layer.";pd3type=rationale;strokeColor=".$strokeColor.";dashed=1;fontSize=14;fillColor=#ffe6cc;strokeWidth=1;dashPattern=1;";
		}elseif($objecttype == 'intention'){
			$style_text="rounded=0;whiteSpace=wrap;html=1;pd3layer=".$object_layer.";pd3type=intention;strokeColor=".$strokeColor.";dashed=1;fontSize=14;fillColor=#ffe6cc;strokeWidth=1;dashPattern=1;";
		}elseif($objecttype == 'annotation'){
			$style_text="rounded=0;whiteSpace=wrap;html=1;pd3layer=".$object_layer.";pd3type=annotation;strokeColor=".$strokeColor.";dashed=1;fontSize=14;fillColor=#ffe6cc;strokeWidth=1;dashPattern=1;";
		}
...
for($i=0;$i<count($ttl_array);$i++){
	...
	//Toolの場合
	}elseif(preg_match("/a pd3:Knowledge;/", $ttl_array[$i])){
		$putXML_middle .= makexml4object($ttl_array[$i],"knowledge");
	//Knowledgeの場合
	}elseif(preg_match("/a pd3:Rationale;/", $ttl_array[$i])){
		$putXML_middle .= makexml4object($ttl_array[$i],"rationale");
	//Rationaleの場合
	}elseif(preg_match("/a pd3:Annotation;/", $ttl_array[$i])){
		$putXML_middle .= makexml4object($ttl_array[$i],"annotation");
	//Annotationの場合
	}elseif(preg_match("/a pd3:Intention;/", $ttl_array[$i])){
		$putXML_middle .= makexml4object($ttl_array[$i],"intention");
	//Intentionの場合
